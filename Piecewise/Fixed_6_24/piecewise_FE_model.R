...
path <- 'R:/SCFreeman/scf20/Melanoma_NMA/Piecewise/Fixed_6_18'
setwd(path)
...
# Cut point at 18 months (so 18 months included as before)
data$z4[data$time<=18] <- 0
data$z4[data$time>18] <- 1
