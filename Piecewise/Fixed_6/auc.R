# Calculate area under the curve from each WinBUGS iteration
...
# vectors for phi
phi1 <- bugs.object$sims.list$phi[,1]
phi2 <- bugs.object$sims.list$phi[,2]
phi3 <- bugs.object$sims.list$phi[,3]
phi4 <- bugs.object$sims.list$phi[,4]
phi5 <- bugs.object$sims.list$phi[,5]
phi6 <- bugs.object$sims.list$phi[,6]
phi7 <- bugs.object$sims.list$phi[,7]
phi8 <- bugs.object$sims.list$phi[,8]
phi9 <- bugs.object$sims.list$phi[,9]
phi10 <- bugs.object$sims.list$phi[,10]
phi11 <- bugs.object$sims.list$phi[,11]
phi12 <- bugs.object$sims.list$phi[,12]
...
foreach(i=1:n) %do% {
  ...
  loghaz[[i]]$trt2 <- c(loghaz[[i]]$trt1[1] + d2[i], loghaz[[i]]$trt1[2] + d2[i] + phi1[i], 
                        loghaz[[i]]$trt1[3] + d2[i] + phi1[i],
                        loghaz[[i]]$trt1[4] + d2[i] + phi1[i], loghaz[[i]]$trt1[5] + d2[i] + phi1[i])
  
  loghaz[[i]]$trt3 <- c(loghaz[[i]]$trt1[1] + d3[i], loghaz[[i]]$trt1[2] + d3[i] + phi2[i], 
                        loghaz[[i]]$trt1[3] + d3[i] + phi2[i],
                        loghaz[[i]]$trt1[4] + d3[i] + phi2[i], loghaz[[i]]$trt1[5] + d3[i] + phi2[i])
  
  loghaz[[i]]$trt4 <- c(loghaz[[i]]$trt1[1] + d4[i], loghaz[[i]]$trt1[2] + d4[i] + phi3[i], 
                        loghaz[[i]]$trt1[3] + d4[i] + phi3[i],
                        loghaz[[i]]$trt1[4] + d4[i] + phi3[i], loghaz[[i]]$trt1[5] + d4[i] + phi3[i])                     
  
  loghaz[[i]]$trt5 <- c(loghaz[[i]]$trt1[1] + d4[i] + d5[i], loghaz[[i]]$trt1[2] + d4[i] + d5[i] + phi4[i], 
                        loghaz[[i]]$trt1[3] + d4[i] + d5[i] + phi4[i], 
                        loghaz[[i]]$trt1[4] + d4[i] + d5[i] + phi4[i], 
                        loghaz[[i]]$trt1[5] + d4[i] + d5[i] + phi4[i]) 
  
  loghaz[[i]]$trt6 <- c(loghaz[[i]]$trt1[1] + d6[i], loghaz[[i]]$trt1[2] + d6[i] + phi5[i], 
                        loghaz[[i]]$trt1[3] + d6[i] + phi5[i],
                        loghaz[[i]]$trt1[4] + d6[i] + phi5[i], loghaz[[i]]$trt1[5] + d6[i] + phi5[i])  
  
  loghaz[[i]]$trt7 <- c(loghaz[[i]]$trt1[1] + d6[i] + d7[i], loghaz[[i]]$trt1[2] + d6[i] + d7[i] + phi6[i], 
                        loghaz[[i]]$trt1[3] + d6[i] + d7[i] + phi6[i], 
                        loghaz[[i]]$trt1[4] + d6[i] + d7[i] + phi6[i], 
                        loghaz[[i]]$trt1[5] + d6[i] + d7[i] + phi6[i])
  
  loghaz[[i]]$trt8 <- c(loghaz[[i]]$trt1[1] + d9[i] - d8[i], loghaz[[i]]$trt1[2] + d9[i] - d8[i] + phi7[i], 
                        loghaz[[i]]$trt1[3] + d9[i] - d8[i] + phi7[i], 
                        loghaz[[i]]$trt1[4] + d9[i] - d8[i] + phi7[i], 
                        loghaz[[i]]$trt1[5] + d9[i] - d8[i] + phi7[i])
  
  loghaz[[i]]$trt9 <- c(loghaz[[i]]$trt1[1] + d9[i], loghaz[[i]]$trt1[2] + d9[i] + phi8[i], 
                        loghaz[[i]]$trt1[3] + d9[i] + phi8[i],
                        loghaz[[i]]$trt1[4] + d9[i] + phi8[i], loghaz[[i]]$trt1[5] + d9[i] + phi8[i])  
  
  loghaz[[i]]$trt10 <- c(loghaz[[i]]$trt1[1] + d9[i] - d8[i] + d10[i], 
                         loghaz[[i]]$trt1[2] + d9[i] - d8[i] + d10[i] + phi9[i], 
                         loghaz[[i]]$trt1[3] + d9[i] - d8[i] + d10[i] + phi9[i], 
                         loghaz[[i]]$trt1[4] + d9[i] - d8[i] + d10[i] + phi9[i], 
                         loghaz[[i]]$trt1[5] + d9[i] - d8[i] + d10[i] + phi9[i])
  
  loghaz[[i]]$trt11 <- c(loghaz[[i]]$trt1[1] + d9[i] - d8[i] + d11[i], 
                         loghaz[[i]]$trt1[2] + d9[i] - d8[i] + d11[i] + phi10[i], 
                         loghaz[[i]]$trt1[3] + d9[i] - d8[i] + d11[i] + phi10[i], 
                         loghaz[[i]]$trt1[4] + d9[i] - d8[i] + d11[i] + phi10[i], 
                         loghaz[[i]]$trt1[5] + d9[i] - d8[i] + d11[i] + phi10[i])
  
  loghaz[[i]]$trt12 <- c(loghaz[[i]]$trt1[1] + d9[i] - d8[i] + d12[i], 
                         loghaz[[i]]$trt1[2] + d9[i] - d8[i] + d12[i] + phi11[i], 
                         loghaz[[i]]$trt1[3] + d9[i] - d8[i] + d12[i] + phi11[i], 
                         loghaz[[i]]$trt1[4] + d9[i] - d8[i] + d12[i] + phi11[i], 
                         loghaz[[i]]$trt1[5] + d9[i] - d8[i] + d12[i] + phi11[i])
  
  loghaz[[i]]$trt13 <- c(loghaz[[i]]$trt1[1] + d13[i], loghaz[[i]]$trt1[2] + d13[i] + phi12[i], 
                         loghaz[[i]]$trt1[3] + d13[i] + phi12[i],
                         loghaz[[i]]$trt1[4] + d13[i] + phi12[i], loghaz[[i]]$trt1[5] + d13[i] + phi12[i])
}
...
# Calculate cumulative hazard up to 60 months only
