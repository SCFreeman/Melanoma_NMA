...
inits <- list(list(alpha=alpha1, beta=beta1, phi=phi1), 
              list(alpha=alpha2, beta=beta2, phi=phi2),
              list(alpha=alpha3, beta=beta3, phi=phi3))

bugs.object<-bugs(data=nma_data, inits=inits, 
                  parameters.to.save=c("alpha", "phi", "S", "rk60"), 
