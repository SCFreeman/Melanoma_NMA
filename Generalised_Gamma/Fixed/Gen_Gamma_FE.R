...
S.trt8 <- 1-pgengamma(x, mu = mu+trt8, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
S.trt9 <- 1-pgengamma(x, mu = mu+trt9, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
S.trt10 <- 1-pgengamma(x, mu = mu+trt10, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
S.trt11 <- 1-pgengamma(x, mu = mu+trt11, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
S.trt12 <- 1-pgengamma(x, mu = mu+trt12, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
S.trt13 <- 1-pgengamma(x, mu = mu+trt13, sigma = sigma, Q=q, lower.tail = TRUE, log.p = FALSE)
