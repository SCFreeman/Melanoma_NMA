# Restricted mean survival time at 18 months
...
rmst_18 <- data.frame(rmst0=NA, rmst0_se=NA, 
                       rmst1=NA, rmst1_se=NA, rmstD=NA, rmstD_lci=NA, rmstD_uci=NA)
...
studies <- data.frame(studyCode=c(1, 2, 3, 11, 12, 13, 5, 9, 10, 7, 8, 6, 4, 4),
                      study=c("BREAK-3", "BRIM-3", "CheckMate 066", "Ribas 2013", "Robert 2011",
                              "Robert 2013", "CheckMate 069", "Hodi 2014", "Keynote 006",
                              "COMBI-d", "COMBI-v", "COBRIM", "CheckMate 067", "CheckMate 067"),
                      t1=c(1, 1, 1, 1, 1, 1, 8, 8, 8, 4, 5, 6, 8, 8),
                      t2=c(4, 6, 9, 2, 3, 13, 10, 12, 11, 5, 6, 7, 9, 10))
...
write.csv(rmst_18, "rmst_18.csv", row.names=F)
